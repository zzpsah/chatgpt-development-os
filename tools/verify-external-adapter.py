...
require(bridge_contract, ["github.inspect.repository", "github.inspect.commit", "github.inspect.workflow_run", "actual provider response", "Remote mutation operations remain unavailable"], "core/runtime-adapter-bridge.md")
require(bridge, ["github.inspect.repository", "github.inspect.commit", "github.inspect.workflow_run", "github_client", "NOT_REQUIRED", "UNAVAILABLE"], "tools/runtime-adapter-bridge.py")
