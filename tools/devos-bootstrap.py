...
REQUIRED = ["AGENTS.md", ".ai/manifest.yaml", ".ai/PROJECT.md", ".ai/CURRENT-STATE.md"]
RECOMMENDED = [".ai/STATE-INDEX.md", ".ai/ARCHITECTURE.md", ".ai/DECISIONS.md", ".ai/TASKS.md", ".ai/CHANGELOG.md"]
