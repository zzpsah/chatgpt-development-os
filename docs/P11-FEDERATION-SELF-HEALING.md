...
2. Explicit project decisions and requirements for intent.
3. Durable `.ai` state for project context and handoff.
4. Deterministic generated indexes for navigation/evidence indexing.
5. AI account memory/chat history as supplementary context only.

## Completion standard

P11 is complete only when a fresh AI/account can recover the project from repository evidence alone, integrity drift can be detected safely, and deterministic context can self-heal without silently changing semantic project intent.
