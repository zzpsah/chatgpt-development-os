...
- **Managed-Repository Delivery v1 Read-Only Preflight — main feature head `fda3e3a6db624d69d6d651cd531c537ad579c9cd`:** added exact local Git-head/clean-worktree/path recovery through P15 → P16 → P17, deterministic approval-request evidence, and an intentional `HOLD` before any managed-repository write. Exact-head CI passed; it does not claim provider or managed-repository mutation.
