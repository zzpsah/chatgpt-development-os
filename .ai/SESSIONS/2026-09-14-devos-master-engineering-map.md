...
- `docs/handoff/README.md` discovery links to the master map and experiment ledger.
...
## Evidence boundary
The map describes current repository architecture and future goals. Future goals are not claims of live provider capability or production readiness. Existing production/live-provider evidence boundaries remain authoritative.
